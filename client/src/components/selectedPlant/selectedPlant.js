    ...
    <div>
      ...
      <div className="row imgSave">
        <div className="col s12 houseSave">
          <a class="waves-effect waves-light btn-small save">Save</a>
        </div>
      </div>

      <div className="row saveInfo">
        <div className="col s3"><i class="far fa-sun sunicon"></i></div>
        <div className="col s9 sun">sunlight</div>
      </div>

      <div className="row rowWater">
        <div className="col s3"><i class="fas fa-tint watericon"></i></div>
        <div className="col s9 water">water amount</div>
      </div>

      <div className="row rowTemp">
        <div className="col s3"><i class="fas fa-temperature-high tempicon"></i></div>
      ...
      <div className="row infoCreate">
          ...
          <div className="col s12 houseCreate">
            <a class="waves-effect waves-light btn-small create">create account</a>
          </div>
